...
public class Nota {
    ...
    public String toString() {
        return "Nota{" + "titulo=" + titulo + ", nota=" + nota + ", fecha=" + fecha + ", usuario=" + usuario + ", ancho=" + ancho + ", alto=" + alto + ", posicionX1=" + posicionX1 + ", posicionX2=" + posicionX2 + ", posicionY1=" + posicionY1 + ", posicionY2=" + posicionY2 + ", color=" + color + '}';
    }
