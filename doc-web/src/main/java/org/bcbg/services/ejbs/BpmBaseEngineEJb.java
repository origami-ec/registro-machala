...
//            flag = taskQuery != null;
    ...
    public List<HistoricTaskInstance> getTaskByProcessInstanceIdMain(String processInstanceId) {
        ...
        String sql = "SELECT TH.* FROM act_hi_taskinst as TH WHERE TH.proc_inst_id_ IN (" + ids + ") ORDER BY TH.start_time_ ASC";
...
//            this.getProcessEngine().close();
    ...
    public InputStream getProcessInstanceDiagram(String procInstId) {
        ...
        if (instance != null) {
            ...
            System.out.println("historicInstance.getProcessDefinitionId()  " + historicInstance.getProcessDefinitionId());
            BpmnModel bpmnModel = engine.getProcessEngine().getRepositoryService().getBpmnModel(historicInstance.getProcessDefinitionId());
