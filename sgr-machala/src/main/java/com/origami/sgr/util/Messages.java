...
public class Messages {
    ...
    public static String transaccionOK = "Elemento guardado con éxito.";
    ...
    public static String enteNoExiste = "El cliente no existe. Proceda a crearlo por favor.";
    ...
    public static String liquidacionAnulada = "La proforma fue anulada.";
