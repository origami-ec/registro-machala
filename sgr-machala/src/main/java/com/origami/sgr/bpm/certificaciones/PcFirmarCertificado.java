...
@Named
@ViewScoped
public class PcFirmarCertificado extends BpmManageBeanBaseRoot implements Serializable {
    ...
    public void completarTareaRevisionRp(Boolean revisionAprobada) {
        try {
            ...
            if (revisionAprobada) {
                ...
                as.enviarCorreoFinTramiteCertificado(liquidacion.getNumTramiteRp(),
                        liquidacion.getBeneficiario().getCorreo1(), archivos, session.getName_user());
            } else {
    ...
    public void updateLiquidacion(){
        try {
            ...
            JsfUti.redirectFaces("/procesos/certificacion/firmarCertificados.xhtml");
        } catch (Exception e) {
            LOG.log(Level.SEVERE, null, e);
