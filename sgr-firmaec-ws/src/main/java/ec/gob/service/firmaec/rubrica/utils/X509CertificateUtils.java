        ...
        if (x509Certificate != null) {
            ...
            if (fechaHora.compareTo(x509Certificate.getNotBefore()) <= 0 || fechaHora.compareTo(x509Certificate.getNotAfter()) >= 0) {
                ...
                if (calendarRecordatorio.getTime().compareTo(fechaHora) <= 0) {
                    ...
                    //System.out.println(PropertiesUtils.getMessages().getProperty("mensaje.advertencia.certificado_advertencia") + simpleDateFormat.format(x509Certificate.getNotAfter().getTime()));
                    System.out.println("// Certificado digital caducará el: " + simpleDateFormat.format(x509Certificate.getNotAfter().getTime()));
                }
            }
            ...
            if ((revocado != null) || caducado || desconocido) {
                ...
                //System.out.println(PropertiesUtils.getMessages().getProperty("mensaje.error.certificado_invalido"));
