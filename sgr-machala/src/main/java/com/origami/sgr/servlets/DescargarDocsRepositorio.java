    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cmis != null) {
                ...
                ContentStream fileStream = cmis.getDocumentSession(request.getParameter("id"));
                response.addHeader("Content-Disposition", "attachment; filename=" + fileStream.getFileName());
