...
@Named
@ViewScoped
public class IngresarDatos extends BpmManageBeanBaseRoot implements Serializable {
    
    private static final Logger LOGGER = Logger.getLogger(IngresarDatos.class.getName());
        ...
        try {
            ...
            if (ta.getRealizado()) {
                ...
                if (ta.getDetalle().getActo().getSolvencia()) {
                    ...
                    JsfUti.redirectFaces("/procesos/inscripciones/inscribirPI.xhtml");
                }
            }
        } catch (Exception e) {
    ...
    public void completarTarea() {
        try {
            if (this.validarTareasV3()) {
                ...
                par = new HashMap<>();
                par.put("aprobado", 1);
                par.put("analistaSeniorInscripcion", itl.getUsuarioByRolName("analista_senior_inscripcion"));
