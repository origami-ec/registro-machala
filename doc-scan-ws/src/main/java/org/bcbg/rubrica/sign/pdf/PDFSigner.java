...
import org.bcbg.rubrica.exceptions.RubricaException;
import org.bcbg.rubrica.exceptions.InvalidFormatException;
import org.bcbg.rubrica.sign.SignInfo;
import org.bcbg.rubrica.sign.Signer;
import org.bcbg.rubrica.certificate.to.DatosUsuario;
import org.bcbg.rubrica.utils.BouncyCastleUtils;
import org.bcbg.rubrica.utils.FileUtils;
import org.bcbg.rubrica.utils.QRCode;
...
public class PDFSigner implements Signer {
    ...
    public byte[] sign(byte[] data, String algorithm, PrivateKey key, Certificate[] certChain, Properties xParams)
        ...
        try {
            ...
            throw new RubricaException(org.bcbg.rubrica.utils.PropertiesUtils.getMessages().getProperty("mensaje.error.driver_problemas") + "\n", ec);
