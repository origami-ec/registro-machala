...
@Named
@ViewScoped
public class RevisarCertificado extends BpmManageBeanBaseRoot implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(RevisarCertificado.class.getName());
    ...
    public void completarTareaRevisionRp(Boolean revisionAprobada) {
        try {
            ...
            if (revisionAprobada) {
                ...
                //as.firmarCertificadosEnviarCorreo(liquidacion, session.getName_user());
