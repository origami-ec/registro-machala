 ...
 */
package org.bcbg.rubrica.certificate;

import java.security.cert.X509Certificate;

import org.bcbg.rubrica.certificate.ec.CertificadoFuncionarioPublico;
import org.bcbg.rubrica.certificate.ec.CertificadoMiembroEmpresa;
import org.bcbg.rubrica.certificate.ec.CertificadoPersonaJuridica;
import org.bcbg.rubrica.certificate.ec.CertificadoPersonaNatural;
import org.bcbg.rubrica.certificate.ec.CertificadoRepresentanteLegal;
import org.bcbg.rubrica.certificate.ec.CertificadoSelladoTiempo;
import org.bcbg.rubrica.certificate.ec.anfac.AnfAc18332SubCaCert20162032;
import org.bcbg.rubrica.certificate.ec.anfac.AnfAc37442SubCaCert20192029;
import org.bcbg.rubrica.certificate.ec.anfac.CertificadoAnfAc18332;
import org.bcbg.rubrica.certificate.ec.anfac.CertificadoAnfAc18332Factory;
import org.bcbg.rubrica.certificate.ec.anfac.CertificadoAnfAc37442;
import org.bcbg.rubrica.certificate.ec.anfac.CertificadoAnfAc37442Factory;
import org.bcbg.rubrica.certificate.ec.bce.BceSubCaCert20112021;
import org.bcbg.rubrica.certificate.ec.bce.BceSubCaCert20192029;
import org.bcbg.rubrica.certificate.ec.bce.CertificadoBancoCentral;
import org.bcbg.rubrica.certificate.ec.bce.CertificadoBancoCentralFactory;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoConsejoJudicaturaDataFactory;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoDepartamentoEmpresaConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoEmpresaConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoMiembroEmpresaConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoPersonaJuridicaPrivadaConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoPersonaJuridicaPublicaConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.CertificadoPersonaNaturalConsejoJudicatura;
import org.bcbg.rubrica.certificate.ec.cj.ConsejoJudicaturaSubCaCert;
import org.bcbg.rubrica.certificate.ec.digercic.CertificadoDigercic;
import org.bcbg.rubrica.certificate.ec.digercic.CertificadoDigercicFactory;
import org.bcbg.rubrica.certificate.ec.digercic.DigercicSubCaCert20212031;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoEclipsoft;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoEclipsoftDataFactory;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoMiembroEmpresaEclipsoft;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoPersonaJuridicaPrivadaEclipsoft;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoPersonalNaturalEclipsoft;
import org.bcbg.rubrica.certificate.ec.eclipsoft.CertificadoRepresentanteLegalEclipsoft;
import org.bcbg.rubrica.certificate.ec.securitydata.CertificadoSecurityData;
import org.bcbg.rubrica.certificate.ec.securitydata.CertificadoSecurityDataFactory;
import org.bcbg.rubrica.certificate.ec.securitydata.SecurityDataSubCaCert20112026;
import org.bcbg.rubrica.certificate.ec.securitydata.SecurityDataSubCaCert20192031;
import org.bcbg.rubrica.certificate.ec.securitydata.SecurityDataSubCaCert20202039;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoMiembroEmpresaUanataca;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoPersonaJuridicaPrivadaUanataca;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoPersonaNaturalUanataca;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoRepresentanteLegalUanataca;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoUanataca;
import org.bcbg.rubrica.certificate.ec.uanataca.CertificadoUanatacaDataFactory;
import org.bcbg.rubrica.certificate.ec.uanataca.UanatacaSubCaCert0120162029;
import org.bcbg.rubrica.certificate.ec.uanataca.UanatacaSubCaCert0220162029;
import org.bcbg.rubrica.certificate.to.DatosUsuario;
import org.bcbg.rubrica.exceptions.EntidadCertificadoraNoValidaException;
import org.bcbg.rubrica.utils.Utils;
    ...
    public static X509Certificate getRootCertificate(X509Certificate certificado) throws EntidadCertificadoraNoValidaException {
        ...
        switch (entidadCertStr) {
            case "Banco Central del Ecuador": {
                try {
                    if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new BceSubCaCert20112021())) {
                        System.out.println("BceSubCaCert 2011-2021");
                        return new BceSubCaCert20112021();
                    }
                    if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new BceSubCaCert20192029())) {
            ...
            case "Security Data": {
                try {
                    if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new SecurityDataSubCaCert20112026())) {
                        System.out.println("SecurityDataSubCaCert");
                        return new SecurityDataSubCaCert20112026();
                    }
                    if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new SecurityDataSubCaCert20192031())) {
                        System.out.println("SecurityDataSubCaCert 2019-2031");
                        return new SecurityDataSubCaCert20192031();
                    }
                    if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new SecurityDataSubCaCert20202039())) {
            ...
            case "Anf AC":
                try {
                if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new AnfAc18332SubCaCert20162032())) {
                    System.out.println("Anf 2016-2032");
                    return new AnfAc18332SubCaCert20162032();
                }
                if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new AnfAc37442SubCaCert20192029())) {
            ...
            case UANATACA_NAME:
                try {
                if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new UanatacaSubCaCert0120162029())) {
                    System.out.println("Uanataca 2016-2029");
                    return new UanatacaSubCaCert0120162029();
                }
                if (org.bcbg.rubrica.utils.Utils.verifySignature(certificado, new UanatacaSubCaCert0220162029())) {
                    System.out.println("Uanataca 2016-2029");
