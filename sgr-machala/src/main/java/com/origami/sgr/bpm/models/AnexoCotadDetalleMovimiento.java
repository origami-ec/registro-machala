...
import com.origami.sgr.util.JsonUtil;
 ...
 * @author Arturo
 */
public class AnexoCotadDetalleMovimiento implements Serializable{
    ...
    private List<AnexoCotadDetalleMovimientoFichas>  fichas = new ArrayList<>();
    private List<AnexoCotadDetalleMovimientoPartes>  intervinientes = new ArrayList<>();
    
    public AnexoCotadDetalleMovimiento() {
    }
    ...
    public List<AnexoCotadDetalleMovimientoFichas> getFichas() {
        return fichas;
    }

    public void setFichas(List<AnexoCotadDetalleMovimientoFichas> fichas) {
        this.fichas = fichas;
    }
    ...
    public String toString() {
        return "AnexoCotadDetalleMovimiento{" + "ROW_NUMBER=" + ROW_NUMBER + ", movimiento_id=" + movimiento_id + ", num_inscripcion=" + num_inscripcion + ", fecha_inscripcion=" + fecha_inscripcion + ", folio_inicio=" + folio_inicio + ", folio_fin=" + folio_fin + ", num_tomo=" + num_tomo + ", num_repertorio=" + num_repertorio + ", fecha_oto=" + fecha_oto + ", escrit_juic_prov_resolucion=" + escrit_juic_prov_resolucion + ", fecha_resolucion=" + fecha_resolucion + ", observacion=" + observacion + ", nombre_acto=" + nombre_acto + ", nombre_libro=" + nombre_libro + ", ente_judicial=" + ente_judicial + ", nombre_canton=" + nombre_canton + ", avaluo_municipal_cadena=" + avaluo_municipal_cadena + ", cuantia_cadena=" + cuantia_cadena + ", intervinientesjs=" + intervinientesjs + ", avaluo_municipal=" + avaluo_municipal + ", cuantia=" + cuantia + ", fichas=" + fichas + ", intervinientes=" + intervinientes + '}';
    }
